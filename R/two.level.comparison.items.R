...
#'
#' Makes a `comparison.items` object. 
#' 
#' A `comparison.items` object has the data from
...
#'
#' @param data a `matrix` or `data.frame` of observed properties from either the control item, or the recovered item
#' @param data.columns vector of integers giving which columns in \code{dat} are the observations of the properties
#'
#' @return
#' @export
#'
